  ...
  return (
    <div style={{display:"flex", height:"400px"}} className='conSv'>
      <div style={{display:"flex", flexDirection:"column", justifyContent:"space-evenly", width:"70%", alignItems:"center"}}>
        <div style={{fontSize:"45px", color:"white", width:"60%", fontWeight:"600"}}>Получите бесплатную консультацию технолога</div>
        <div style={{fontSize:"45px", color:"white", width:"60%", fontWeight:"600"}}>
